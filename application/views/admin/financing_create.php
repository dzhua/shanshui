						...
						<div class="data-container">
							<header>
								...
								<ul class="data-header-actions">
									<li class="demoTabs"><a class="btn" href="/admin/financing">理财项目一览</a></li>
								</ul>
							</header>
							<section class="tab-content">
								...
								<div id="basic" class="tab-pane active">
									...
									<div class="row-fluid">
									  <div class="span8">
											<form action="/admin/financing/do_create" method="post" id="myform" enctype="multipart/form-data">
												<fieldset>
													...
													<div class="control-group">
														<label for="input" class="control-label">认购总额</label>
														<div class="controls">
															<input type="text" class="input-xlarge" id="total" name="total">
														</div>
													</div>
													<div class="control-group">
														<label for="input" class="control-label">锁定期</label>
														<div class="controls">
													...
													<div class="control-group">
														<label for="input" class="control-label">年利率</label>
														<div class="controls">
															<input type="text" class="input-xlarge" id="rate" name="rate">
														</div>
													</div>		
													<div class="control-group">
														<label for="input" class="control-label">最小份额</label>
														<div class="controls">
															<input type="text" class="input-xlarge" id="min_share" name="min_share">
														</div>
													</div>								
													<div class="control-group">
